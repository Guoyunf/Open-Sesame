...
_ATTR_TO_MODULE = {
    ...
    "get_elevator_button_coords_manual": "tasks.elevator_button_detection",
    "get_elevator_button_coords_model": "tasks.elevator_button_detection",
    ...
    "press_elevator_button": "tasks.elevator_button_press_task",
